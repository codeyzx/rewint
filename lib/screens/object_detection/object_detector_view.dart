...
class ObjectDetectionScreen extends StatefulWidget {
  ...
  static const String routeName = '/object-detection';

  @override
  _ObjectDetectionScreen createState() => _ObjectDetectionScreen();
}

class _ObjectDetectionScreen extends State<ObjectDetectionScreen> {
  ...
  Future<void> processImage(InputImage inputImage) async {
    ...
    if (inputImage.inputImageData?.size != null &&
      ...
      for (final object in objects) {
        ...
        // print('objjj: ${object.labels.first.text}');
        // text += object.labels.first.text;
        List<String> temp = object.labels.map((e) => e.text).toList();
        if (temp.isNotEmpty) {
          text += temp[0];
        } else {
