...
class Resultcreen extends GetView<QuizController> {
  ...
  Widget build(BuildContext context) {
    final resultTemp = controller.correctQuestionCount == 0
        ? 0
        : (controller.allQuestions.length / controller.correctQuestionCount) *
            10;
    final result = resultTemp.toInt();
